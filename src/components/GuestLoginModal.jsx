...
const GuestLoginModal = ({ isOpen, onClose, onLoginSuccess }) => {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        ...
        <div className="p-6">
          ...
          <button
            ...
            className="w-full bg-white border-2 border-gray-300 hover:border-gray-400 disabled:bg-gray-100 text-gray-700 font-semibold py-2 px-4 rounded-lg transition duration-200 flex items-center justify-center gap-2 mb-4"
          >
